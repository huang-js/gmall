...
//    }
    ...
    @ResponseBody
    public List<UmsMemberReceiveAddress> getMemberReceiveAddressById(@PathVariable("memberId") String memberId){
        List<UmsMemberReceiveAddress> receiveAddress = userService.getMemberReceiveAddressById(memberId);
        return receiveAddress;
    }
    //更新会员信息
